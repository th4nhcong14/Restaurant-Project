...
export default {
    ...
    methods: {
        async updateProduct() {
            ...
            const result = await axios.put('http://localhost:3000/product-airpods/'+this.$route.params.id,
            {
    ...
    async mounted() {
        ...
        const result = await axios.get('http://localhost:3000/product-airpods/'+this.$route.params.id)
